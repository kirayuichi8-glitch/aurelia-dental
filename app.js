...
const assistantKnowledge = [
  ...
  { keys: ['цена','стоит','стоимость','прайс','дорого'], text: 'Первичная диагностика — от 1 900 ₽, лечение кариеса — от 6 500 ₽, имплантация — от 39 000 ₽. Точную сумму врач фиксирует после диагностики, до начала лечения. Что вас интересует?', quick: ['Лечение зубов','Имплантация','Эстетика'] },
